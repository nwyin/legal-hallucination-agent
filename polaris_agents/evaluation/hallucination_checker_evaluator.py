"""
Hallucination checker evaluation.

Evaluates predicted hallucinated citations against ground truth using
precision, recall, and F1. A ground truth item is a "hit" if it is a
substring of a predicted item (or a predicted item is a substring of it).
"""
